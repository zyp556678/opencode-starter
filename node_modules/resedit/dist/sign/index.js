...
import SpcPeImageData, { SpcPeImageAttributeTypeAndOptionalValue, SpcPeImageFlags, } from './data/SpcPeImageData.js';
...
export function generateExecutableWithSign(executable, signer, alignment) {
    ...
    calculateExecutableDigest(executable, signer, certAlignment)
        ...
        var content = new SpcIndirectDataContent(new SpcPeImageAttributeTypeAndOptionalValue(new SpcPeImageData(SpcPeImageFlags.IncludeResources, new SpcLinkFile(''))), new DigestInfo(digestAlgorithm, digest));
        return (signer
